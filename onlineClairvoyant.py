...
def main():
    ...
    balance_fit pm usage trimmed mean: 2566810.23625
    balance_fit pm usage mean: 2753541.405
    balance_fit max pm mean: 21.791
    clairvoyant_ltfit 8000 pm usage trimmed mean: 2301357.02625
